...
layui.use(['jquery', 'layer', 'common', 'form', 'element', 'tree', 'laydate'], function () {
    ...
    function targetUrl(type) {
        ...
        var end_times = get_time(objFormData.start_time);
      
        window.location.href = '/index.php/Home/Order/day_' + type + '_linen_month_order?customer_id=' +
