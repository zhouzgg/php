    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <blockquote class="layui-elem-quote">
                <?php echo ($title); ?>
                <a target=_top href="<?php echo U('Supplier/export_supplier_list');?>" class="layui-btn output-data"><?php echo (L("_EXPORT_EXCEL_TABLE_")); ?></a>
            </blockquote>
            ...
            <div class="layui-body-container">
                ...
                <table class="layui-table">
                    ...
                    <thead>
                    <tr>
                        <th><?php echo (L("_SUPPLIER_NO_")); ?></th>
                        <th><?php echo (L("_SUPPLIER_NAME_")); ?></th>
                        <th><?php echo (L("_SUPPLIER_PRINCIPAL_")); ?></th>
                        <th><?php echo (L("_SUPPLIER_PHONE_")); ?></th>
                        <th><?php echo (L("_SUPPLIER_ADDRESS_")); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                                <td><?php echo ($var["SUPPLIER_ID"]); ?></td>
                                <td><?php echo ($var["SUPPLIER_NAME"]); ?></td>
                                <td><?php echo ($var["SUPPLIER_CONTACT_PERSON"]); ?></td>
                                <td><?php echo ($var["SUPPLIER_CONTACT_PHONE"]); ?></td>
                                <td><?php echo ($var["SUPPLIER_ADDRESS"]); ?></td>
...
<!--按每个页面引入-->
<script src="/Public/static/js/supplier/supplier_list.js"></script>
</html>