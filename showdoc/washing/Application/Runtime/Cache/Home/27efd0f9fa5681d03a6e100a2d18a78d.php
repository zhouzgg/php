            ...
            <div class="layui-body-container order">
                ...
                <table class="layui-table">
                    ...
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="/index.php/Home/Order/clean_order_details?lib=<?php echo ($val["RECEIPT_MAIN_ID"]); ?>"
                                       class="layui-btn layui-btn-primary layui-btn-radius sld_see-more"><?php echo (L("_VIEW_DETAIL_")); ?></a>
                                </td>
