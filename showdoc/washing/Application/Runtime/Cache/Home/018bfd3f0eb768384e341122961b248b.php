    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <blockquote class="layui-elem-quote">
                <?php echo ($title); ?>
                <a target=_top href="<?php echo U('Driver/export_driver_list');?>"
                   class="layui-btn output-data"><?php echo (L("_EXPORT_EXCEL_TABLE_")); ?></a>
            </blockquote>
            ...
            <div class="layui-body-container">
                ...
                <table class="layui-table">
                    ...
                    <thead>
                    <tr>
                        <th><?php echo (L("_DRIVER_NO_")); ?></th>
                        <th><?php echo (L("_DRIVER_NAME_")); ?></th>
                        <th><?php echo (L("_DRIVER_PHONE_")); ?></th>
                        <th><?php echo (L("_OPERATING_")); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                                <td><?php echo ($var["DRIVER_ID"]); ?></td>
                                <td><?php echo ($var["DRIVER_NAME"]); ?></td>
                                <td><?php echo ($var["DRIVER_PHONE"]); ?></td>
                                <td>
                                    <button class="layui-btn layui-btn-radius edit" data-id="<?php echo ($var["DRIVER_ID"]); ?>"><?php echo (L("_EDIT_")); ?></button>
                                    <!--<button class="layui-btn layui-btn-radius layui-btn-danger del">删除</button>-->
                                </td>
                            </tr><?php endforeach; endif; ?>
                        <?php else: ?>
                        <tr>
                            <td colspan="4"> <p class="layui-word-aux">
...
<!--按每个页面引入-->
<script src="/Public/static/js/driver/driver_list.js"></script>
</html>