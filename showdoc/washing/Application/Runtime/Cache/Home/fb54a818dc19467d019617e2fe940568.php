    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <blockquote class="layui-elem-quote">
                <?php echo ($title); ?>
                <a href="javascript:" class="layui-btn output-data"><?php echo (L("_EXPORT_EXCEL_TABLE_")); ?></a>
            </blockquote>
            <!--每个页面为了保持样式不冲突必须 唯一的样式必须统一一个不一样的类名-->

            <div class="layui-body-container new-product">
                <div class="layui-form">

                    <div class="layui-inline">
                        <label class="layui-form-label"><?php echo (L("_NEWPRODUCT_SELECT_WASHING_")); ?></label>
                        <div class="layui-input-inline">
                            <select name="modules" id="check_washing_store" lay-verify="required" lay-search="">
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label"><?php echo (L("_NEWPRODUCT_DATA_SELECT_")); ?>：</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" id="check_data" placeholder=" - ">
                        </div>
                    </div>

                    <div class="layui-inline">
                        <a href="javascript:" class="layui-btn search-btn"><?php echo (L("_GO_SEARCH_")); ?></a>
                        <a href="javascript:" class="layui-btn layui-btn-primary clear-btn"><?php echo (L("_CLEAR_SEARCH_")); ?></a>
                    </div>
                </div>
                ...
                <table class="layui-table">
                    <thead>
                    <tr>
                        <th><?php echo (L("_NEWPRODUCT_STORAGE_TIME_")); ?></th>
                        <th><?php echo (L("_NEWPRODUCT_STORAGE_TYPE_")); ?></th>
                        <th><?php echo (L("_NEWPRODUCT_STORAGE_NO_")); ?></th>
                        <th><?php echo (L("_NEWPRODUCT_GO_STOREHOUSE_")); ?></th>
                        <th><?php echo (L("_NEWPRODUCT_RECEIVE_PEOPLE_")); ?></th>
                        <th><?php echo (L("_NEWPRODUCT_STOREHOUSE_MANAGE_")); ?></th>
                        <th><?php echo (L("_NEWPRODUCT_SUPPLIER_")); ?></th>
                        <th><?php echo (L("_NEWPRODUCT_LIST_DETAIL_")); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <!--数据渲染-->
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                                ...
                                <td><?php echo ($val["RECEIPT_MAIN_ID"]); ?></td>
                                <td><?php echo ($val["WAREHOUSE_NAME"]); ?></td>
                                <td><?php echo ($val["USER_NAME"]); ?></td>
                                <td><?php echo ($val["WAREHOUSE_CONTACT_PERSON"]); ?></td>
                                <td></td>
                                <td>
                                    <a href="/index.php/Home/NewProduct/new_product_details?lid=<?php echo ($val["RECEIPT_MAIN_ID"]); ?>"
                                       class="layui-btn layui-btn-primary layui-btn-radius"><?php echo (L("_VIEW_DETAIL_")); ?></a>
                                </td>
...
<!--按每个页面引入-->
<script src="/Public/static/js/new_product/new_product.js"></script>
</html>