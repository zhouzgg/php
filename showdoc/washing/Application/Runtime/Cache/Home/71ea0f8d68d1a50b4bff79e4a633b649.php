                ...
                <!--<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
                    <legend>
                          <span class="layui-breadcrumb" lay-separator="—">
                            <a href="javascript:"><cite><?php echo (L("_INVENTORY_CURRENT_SELECT_")); ?>：</cite></a>
                    ...
                    <ul class="layui-timeline" style="margin-top: 20px;">
                        <li class="layui-timeline-item">
                            ...
                            <div class="layui-timeline-content layui-text">
                                <h3 class="layui-timeline-title"><?php echo (L("_INVENTORY_FIRST_STEP_")); ?></h3>
                                ...
                                <div class="timeline-container">
                                    ...
                                    <div class="layui-btn choose-custom" style='margin-top: 40px;'><?php echo (L("_INVENTORY_SELECT_")); ?></div>
                                </div>
                            </div>
                        </li>
                        <li class="layui-timeline-item">
                            ...
                            <div class="layui-timeline-content layui-text">
                                <h3 class="layui-timeline-title"><?php echo (L("_INVENTORY_SECOND_STEP_")); ?></h3>

                                <div class="timeline-container hide">
                                    <div id="ifuner_tree" class="clearfix">

                                    </div>
                                    <div class="layui-btn choose-enter" style='margin-top: 40px;'><?php echo (L("_INVENTORY_SURE_")); ?></div>
                                </div>
                            </div>
                        </li>
                    </ul>
...
<script src="/Public/static/lib/layui/lay/modules/layui-xtree.js"></script>
<!--按每个页面引入-->
<script src="/Public/static/js/inventory/inventory_choose.js?data=171207"></script>
<script>
