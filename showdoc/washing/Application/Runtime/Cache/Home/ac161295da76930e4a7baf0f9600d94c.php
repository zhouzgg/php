        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-body-container">
                ...
                <table class="layui-table">
                    ...
                    <thead>
                    <tr>
                        <th><?php echo (L("_CAR_NO_")); ?></th>
                        <th><?php echo (L("_CAR_NAME_")); ?></th>
                        <th><?php echo (L("_CAR_PHONE_")); ?></th>
                        <th><?php echo (L("_OPERATING_")); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                                <td><?php echo ($var["CAR_ID"]); ?></td>
                                <td><?php echo ($var["CAR_NAME"]); ?></td>
                                <td><?php echo ($var["CAR_NUMBER"]); ?></td>
                                <td>
                                    <button class="layui-btn layui-btn-radius edit" data-id="<?php echo ($var["CAR_ID"]); ?>"><?php echo (L("_EDIT_")); ?></button>
...
<!--按每个页面引入-->
<script src="/Public/static/js/car/car_list.js"></script>
</html>