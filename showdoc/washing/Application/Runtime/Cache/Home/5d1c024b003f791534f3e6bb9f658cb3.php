    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-body-container store-house">
                <div class="add-store-house layui-form">

                    <div class="layui-form-item layui-input-inline">
                        <label class="layui-form-label"><?php echo (L("_DEPARTMENT_CUSTOMER_")); ?></label>
                        <div class="layui-input-inline custom">
                            <select name="modules" id="custom" lay-filter="customfilter" lay-verify="required" lay-search="">
                    ...
                    <div class="layui-form-item layui-input-inline">
                        <label class="layui-form-label"><?php echo (L("_DEPARTMENT_MANAGER_")); ?></label>
                        <div class="layui-input-inline depart">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" id="title" lay-verify="title" autocomplete="off" placeholder="<?php echo (L("_PLEASE_INPUT_NAME_")); ?>"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="address" id="address" lay-verify="required" placeholder="<?php echo (L("_PLEASE_INPUT_NAME_")); ?>"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="username" id="username" lay-verify="required" placeholder="<?php echo (L("_PLEASE_INPUT_PERSON_")); ?>"
                                   autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="tel" name="phone" id="phone" placeholder="<?php echo (L("_PLEASE_INPUT_PHONE_")); ?>" lay-verify="phone" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
...
<!--按每个页面引入-->
<script src="/Public/static/js/StoreHouse/addStoreHouse.js?data=17121814"></script>
</html>