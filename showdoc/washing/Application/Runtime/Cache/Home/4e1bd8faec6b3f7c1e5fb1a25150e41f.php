    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <blockquote class="layui-elem-quote">
                <?php echo ($title); ?>
                <a target=_top href="/index.php/Home/Department/export_department_list?customer_id=<?php echo ($customer_id); ?>" class="layui-btn output-data"><?php echo (L("_EXPORT_EXCEL_TABLE_")); ?></a>
            </blockquote>
            ...
            <div class="layui-body-container custom">
                ...
                <div class="layui-form">
                    <div class="layui-inline">
                        <label class="layui-form-label"><?php echo (L("_SELECT_CUSTOMER_")); ?></label>
                        <div class="layui-input-inline">
                            <select name="modules" id="custom-name" lay-verify="required" lay-search="">
                                <option value=""><?php echo (L("_SELECT_OR_SEARCH_")); ?></option>
                                <?php if(is_array($customerNameList)): foreach($customerNameList as $key=>$var): ?><option value="<?php echo ($var["CUSTOMER_ID"]); ?>" <?php if($var["CUSTOMER_ID"] == $customer_id): ?>selected<?php endif; ?>><?php echo ($var["CUSTOMER_NAME"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                ...
                <table class="layui-table">
                    <thead>
                    <tr>
                        <th><?php echo (L("_CUSTOMER_ID_")); ?></th>
                        <th><?php echo (L("_CUSTOMER_INPUT_DEPARTMENT_")); ?></th>
                        <th><?php echo (L("_CUSTOMER_CONTACT_PERSON_")); ?></th>
                        <th><?php echo (L("_CUSTOMER_CONTACT_PHONE_")); ?></th>
                        <th><?php echo (L("_CUSTOMER_SUBSIDIARY_")); ?></th>
                        <th><?php echo (L("_CUSTOMER_DEPARTMENT_")); ?></th>
                        <!--<th>操作</th>-->
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                                ...
                                <td><?php echo ($var["DEPARTMENT_CONTACT_PERSON"]); ?></td>
                                <td><?php echo ($var["DEPARTMENT_CONTACT_PHONE"]); ?></td>
                                <td><?php echo ($var["CUSTOMER_NAME"]); ?></td>
                                <td><?php echo ($var["PARENT_NAME"]); ?></td>
                                <!--<td>-->
                                <!--<a href="/index.php/Home/custom/custom_list_details?lid=<?php echo ($var["DEPARTMENT_ID"]); ?>"-->
                                <!--class="layui-btn layui-btn-primary layui-btn-radius sld_see-more">查看详情</a>-->
                                <!--</td>-->
                            </tr><?php endforeach; endif; ?>
                        <?php else: ?>
                        <tr>
                            <td colspan="7"><p class="layui-word-aux">
