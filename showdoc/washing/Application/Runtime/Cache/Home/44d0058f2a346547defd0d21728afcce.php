...
<link rel="stylesheet" href="/Public/static/lib/layer/skin/default/layer.css" media="all">
    ...
    <link rel="stylesheet" href="/Public/static/lib/zTree_v3/css/metroStyle/metroStyle.css" type="text/css">
</head>
<body>
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-body-container user">
                ...
                <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
                    <legend><?php echo (L("_USER_AUDIT_BASIC_MANAGE_")); ?></legend>
                </fieldset>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo (L("_USER_SELECT_ROLE_")); ?></label>
                        <div class="layui-input-inline">
                            <select name="modules" id="choose_part" lay-verify="required" lay-search="">
                                <option value=""><?php echo (L("_SELECT_OR_SEARCH_")); ?></option>
                                <?php if(is_array($rolelist)): foreach($rolelist as $key=>$var): ?><option value="<?php echo ($var["ROLE_ID"]); ?>"><?php echo ($var["ROLE_NAME"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>

                    <fieldset class="layui-elem-field layui-field-title">
                        <legend><?php echo (L("_USER_AUDIT_SETTING_")); ?></legend>
                    </fieldset>

                    <div class="layui-field-box ztree-box">
                    ...
                    <div class="layui-form-item layui-input-block">
                        <button class="layui-btn layui-btn-big save"><?php echo (L("_USER_BTN_SAVE_")); ?></button>
                        <a href="javascript:window.location.reload()" class="layui-btn layui-btn-primary layui-btn-big"><?php echo (L("_USER_BTN_INIT_")); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<!--按每个页面引入-->
<script type="text/javascript" src="/Public/static/lib/zTree_v3/js/jquery-1.4.4.min.js"></script>
<script type="text/javascript" src="/Public/static/lib/zTree_v3/js/jquery.ztree.core.js"></script>
<script type="text/javascript" src="/Public/static/lib/zTree_v3/js/jquery.ztree.excheck.js"></script>
<script type="text/javascript" src="/Public/static/lib/zTree_v3/js/jquery.ztree.exedit.js"></script>

<script src="/Public/static/js/user/user_auth.js"></script>
</html>