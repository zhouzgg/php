                ...
                <form action="" class="layui-form">
                    <ul class="layui-timeline" style="margin-top: 20px;">
                        ...
                        <li class="layui-timeline-item">
                            ...
                            <div class="layui-timeline-content layui-text">
                                <h3 class="layui-timeline-title"><?php echo (L("_ORDER_THIRD_STEP_")); ?></h3>
                                <!--隐藏的表单-->
                                <div class="timeline-container hide">
                                    <div class="layui-row layui-col-space20" id="storehouse_list"></div>
                                    <div class="layui-btn choose-enter" style='margin-top: 40px;'><?php echo (L("_ORDER_SURE_")); ?></div>
                                </div>
                            </div>
                        </li>

                        <li class="layui-timeline-item">
                            <span class="layui-icon time-num">4</span>
                            <div class="layui-timeline-content layui-text">
                                <h3 class="layui-timeline-title"><?php echo (L("_ORDER_TOURTH_STEP_")); ?></h3>
                                <!--隐藏的表单-->
                                <div class="timeline-container hide">
                                    <div class="layui-row layui-col-space20">
                                        <?php if(is_array($washing_list)): foreach($washing_list as $key=>$val): ?><div class="layui-col-xs4 layui-col-sm3 layui-col-md2 layui-col-lg1">
                                                <input type="radio" name="choose_washing" title="<?php echo ($val["WAREHOUSE_NAME"]); ?>" value="<?php echo ($val["WAREHOUSE_ID"]); ?>">
                                            </div><?php endforeach; endif; ?>
                                    </div>
                                    <fieldset class="layui-elem-field" style="margin-top: 20px;">
                                        <legend><?php echo (L("_ORDER_DATA_SELECT_")); ?></legend>
...
<!--按每个页面引入-->
<script src="/Public/static/js/order/order_choose.js?data=171215"></script>
</html>