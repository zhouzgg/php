            ...
            <div class="layui-body-container">
                <div class="layui-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo (L("_NAME_")); ?></label>
                        <div class="layui-input-block">
                            <input type="text" name="title" id="title" lay-verify="title" autocomplete="off" placeholder="<?php echo (L("_NOT_CUSTOMER_NAME_")); ?>"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo (L("_ADDRESS_")); ?></label>
                        <div class="layui-input-block">
                            <input type="text" name="address" id="address" lay-verify="required" placeholder="<?php echo (L("_NOT_CUSTOMER_ADDRESS_")); ?>"
                                   autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo (L("_PERSON_")); ?></label>
                        <div class="layui-input-block">
                            <input type="text" name="username" id="username" lay-verify="required" placeholder="<?php echo (L("_NOT_WASHING_CONTACT_PERSON_")); ?>"
                                   autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo (L("_PHONE_")); ?></label>
                        <div class="layui-input-block">
                            <input type="tel" name="phone" id="phone" placeholder="<?php echo (L("_NOT_WASHING_CONTACT_PHONE_")); ?>" lay-verify="phone" autocomplete="off"
                                   class="layui-input" maxlength="11">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo (L("_UPLOAD_LOGO_")); ?></label>
                        <div class="layui-input-block">
                            <button type="button" class="layui-btn layui-btn-danger" id="test7"><i class="layui-icon"></i><?php echo (L("_UPLOAD_IMG_")); ?></button>
                            <div class="layui-inline layui-word-aux">
                                <?php echo (L("_UPLOAD_IMG_REQUIRE_")); ?>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item showLogo" style="display: none">
                        <label class="layui-form-label">logo</label>
                        <div class="layui-inline">
                            <img src="" alt="">
                            <span class="layui-icon" onclick="ifuner.remove()">&#x1007;</span>
                        </div>
                    </div>
                    <div class="layui-form-item layui-input-block">
                        <button class="layui-btn layui-btn-big" onclick=" ifuner.add('index.php/Home/Custom/post_customer',2)"><?php echo (L("_BUTTON_ADD_")); ?></button>
                        <button class="layui-btn layui-btn-primary layui-btn-big" onclick="ifuner.reset()"><?php echo (L("_BUTTON_RESET_")); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<!--按每个页面引入-->
<script src="/Public/static/js/add/uploadLogo.js?data=171218"></script>
</html>