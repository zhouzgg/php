    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <blockquote class="layui-elem-quote">
                <?php echo ($title); ?>
                <a target=_top href="<?php echo U('WashingPlants/export_washing_plant');?>" class="layui-btn output-data"><?php echo (L("_EXPORT_EXCEL_TABLE_")); ?></a>
            </blockquote>
            <!--每个页面为了保持样式不冲突必须 唯一的样式必须统一一个不一样的类名-->
            <div class="layui-body-container washing_plant_list">
                <table class="layui-table">
                    ...
                    <thead>
                    <tr>
                        <th><?php echo (L("_WASHING_NO_")); ?></th>
                        <th><?php echo (L("_WASHING_NAME_")); ?></th>
                        <th><?php echo (L("_WASHING_ADDRESS_")); ?></th>
                        <th><?php echo (L("_WASHING_PERSON_")); ?></th>
                        <th><?php echo (L("_WASHING_PHONE_")); ?></th>
                        <!--<th><?php echo (L("_WASHING_SETTING_")); ?></th>-->
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                                ...
                                <!--<td>-->
                                    <!--<a href="<?php echo U('WashingPlants/washing_plant_list_details');?>?lid=<?php echo ($var["WAREHOUSE_ID"]); ?>"-->
                        ...
                        <tr>
                            <td colspan="6">
                                <p class="layui-word-aux">
                                    <span class="layui-icon"> &#xe69c;</span><?php echo (L("_LIST_NOT_DATA_")); ?>
                                </p>
                            </td>
                        </tr><?php endif; ?>
                    </tbody>
