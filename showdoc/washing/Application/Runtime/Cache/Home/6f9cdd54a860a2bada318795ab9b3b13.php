                ...
                <div class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" id="title" lay-verify="title" autocomplete="off" placeholder="<?php echo (L("_NOT_WASHING_NAME_")); ?>"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="address" id="address" lay-verify="required" placeholder="<?php echo (L("_NOT_WASHING_ADDRESS_")); ?>"
                    ...
                    <div class="layui-form-item layui-input-block">
                        <button class="layui-btn layui-btn-big" onclick="ifuner.add('index.php/Home/WashingPlants/post_washing_plant',1)"><?php echo (L("_BUTTON_ADD_")); ?></button>
...
<!--按每个页面引入-->
<script src="/Public/static/js/add/uploadLogo.js"></script>
</html>