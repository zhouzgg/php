 ...
 foreach($child['children'] as $tchild) { $childSelect = ""; if($tchild['id'] == $childNode){ $childSelect = "layui-this"; } ?>
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-body-container device">
                ...
                <div class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label"><?php echo (L("_DEVICE_NAME_")); ?></label>
                            <div class="layui-input-inline">
                                <input type="text" name="device_name" id="device_name" lay-verify="title"
                                       autocomplete="off"
                                       placeholder="<?php echo (L("_DEVICE_ADD_NOT_NAME_")); ?>"
                                       class="layui-input">
                            </div>
                        </div>

                        <div class="layui-inline">
                            <label class="layui-form-label"><?php echo (L("_DEVICE_NO_")); ?></label>
                            <div class="layui-input-inline">
                                <input type="text" name="device_id" id="device_id" lay-verify="title" autocomplete="off"
                                       placeholder="<?php echo (L("_DEVICE_ADD_NOT_NUMBER_")); ?>"
                                       class="layui-input">
                            </div>
                        </div>

                        <div class="layui-inline">
                            <label class="layui-form-label"><?php echo (L("_DEVICE_USERS_")); ?></label>
                            <div class="layui-input-inline">
                                <input type="text" name="title" id="receiver" lay-verify="title" autocomplete="off"
                                       placeholder="<?php echo (L("_DEVICE_INPUT_USERS_")); ?>"
                                       class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="device-num">
                        <div>
                            <p>XX<?php echo (L("_DEVICE_ONE_")); ?></p>
                            <p><?php echo ($servercount); ?></p>
                        </div>
                        <!--<div>
                            <p>XX设备(台)</p>
                            <p>12312312</p>
                    ...
                    <table class="layui-table">
                        ...
                        <thead>
                        <tr>
                            <th><?php echo (L("_DEVICE_NUMBER_")); ?></th>
                            <th><?php echo (L("_DEVICE_NAME_")); ?></th>
                            <th><?php echo (L("_DEVICE_NO_")); ?></th>
                            <th><?php echo (L("_DEVICE_USERS_")); ?></th>
                            <th><?php echo (L("_DEVICE_PHONE_")); ?></th>
                            <th><?php echo (L("_DEVICE_USE_TIME_")); ?></th>
                            <th><?php echo (L("_DEVICE_BUY_TIME_")); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if(!empty($list)): if(is_array($list)): foreach($list as $k=>$var): ?><tr>
                                    <td><?php echo ($k); ?></td>
                                    <td><?php echo ($var["READER_NAME"]); ?></td>
                                    <td><?php echo ($var["READER_ID"]); ?></td>
                                    <td><?php echo ($var["USER_NAME"]); ?></td>
                                    <td><?php echo ($var["CELLPHONE"]); ?></td>
                                    <td><?php echo ($var["REG_TIME"]); ?></td>
                                    <td></td>
...
<!--按每个页面引入-->
<script src="/Public/static/js/device/device_list.js?data=171205"></script>
</html>