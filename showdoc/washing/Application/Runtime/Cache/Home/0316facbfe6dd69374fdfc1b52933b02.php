               ...
               <table class="layui-table">
                    ...
                    <!--数据渲染-->
                     <?php if(!empty($list)): if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($key % 2 );++$key;?><tr>
                                <td><?php echo ($key); ?></td>
                                <?php if(is_array($date)): $i = 0; $__LIST__ = $date;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><?php echo ($val[$v]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
                                <td><?php echo ($val['合计']); ?></td>
