    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <blockquote class="layui-elem-quote">
                <?php echo ($title); ?>
                <a href="<?php echo ($url); ?>" class="layui-btn output-data"><?php echo (L("_EXPORT_EXCEL_TABLE_")); ?></a>
            </blockquote>
            ...
            <div class="layui-body-container order">
                <table class="layui-table" lay-skin="line">
                    ...
                    <tr>
                        ...
                        <td><?php echo (L("_ORDER_STOREHOUSE_")); ?>：<?php echo ($other["storehouse"]); ?></td>
                    </tr>
                    <tr>
                        <td colspan="3"><?php echo (L("_ORDER_TIME_")); ?>：<?php echo ($other["start_time"]); ?>~<?php echo ($other["end_time"]); ?></td>
                    </tr>
                    </tbody>
                </table>
                <table class="layui-table">
                    <thead>
                    <tr>
                        <th><?php echo (L("_ORDER_NO_")); ?></th>
                        <th><?php echo (L("_ORDER_REQUEST_TIME_")); ?></th>
                        <th><?php echo (L("_ORDER_SEND_")); ?></th>
                        <th><?php echo (L("_ORDER_REQUEST_")); ?></th>
                        <th><?php echo (L("_ORDER_REIVER_")); ?></th>
                        <th><?php echo (L("_ORDER_REQUEST_DEVICE_")); ?></th>
                        <th><?php echo (L("_ORDER_DRIVER_")); ?></th>
                        <th><?php echo (L("_ORDER_CAR_")); ?></th>
                    ...
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$val): ?><tr>
                                ...
                                <td><?php echo ($val["STOREHOUSE_NAME"]); ?></td>
                                <td><?php echo ($val["WAREHOUSE_NAME"]); ?></td>
                                <td><?php echo ($val["USER_NAME"]); ?></td>
                                <td><?php echo ($val["READER_ID"]); ?></td>
                                <td></td>
                                <td></td>
                                <td>
                                    <a href="/index.php/Home/Order/dirty_order_details?lid=<?php echo ($val["RECEIPT_MAIN_ID"]); ?>"
